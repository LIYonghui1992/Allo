...
//        @imagestring($im, 5, 5, 3, $randval, $stringColor);
    ...
    /* only imagestring params diffrent from function buildImageVerify*/
     static function buildImageVerify_big($length=4,$mode=1,$type='png',$width=48,$height=22,$verifyName='verify')

    {
		...
		for($i=0;$i<$length;$i++) {
			...
			imagestring($im,10,$i*20+45,mt_rand(10,30),$randval{$i}, $stringColor);
