...
//			var_dump($this->fields);
   ...
   /**
    ...
    {//var_dump("content index");
    	$template =  file_exists(APP_PATH.'Tpl/Admin/Default/'.MODULE_NAME.'_index.html') ? 'index' : 'Content:index';
...
*/
    ...
    if($module=="Design_winner")
		{
			$_POST['winneryear'] = date('Y',$_POST['winner_date']);
		}
		
		if($module=="Ship_price")
		{
			$country = M('Country')->where('id ='.$_POST['country_id'])->find();
			$_POST['country'] = $country['title'];
...
//error_log(json_encode($_POST));
		...
		//error_log('winnerdate:'.$_POST['winner_date']);
		//****************
