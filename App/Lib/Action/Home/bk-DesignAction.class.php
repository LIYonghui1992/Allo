...
/**
    ...
    */
        ...
        $pp_info['return'] = 'http://www.allocacoc.com/Design/index.html';// http://test.allocacoc.com/Design/index.html 当用户成功付款后paypal会将用户自动引导到此页面。如果为空或不传递该参数，则不会跳转  
        ...
        unset($pp_info);  
			...
			if ($_POST['paytype']==2)
			{
				\Stripe\Stripe::setApiKey("sk_live_OghD65j74QWhlUkrwg6zxdic");//sk_test_f3jgU2hZxqndFQI7j9qpThSD
